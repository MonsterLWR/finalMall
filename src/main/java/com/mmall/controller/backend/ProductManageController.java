...
public class ProductManageController {
    ...
    public ServerResponse productSave(HttpSession session, Product product) {
        /**
         * 功能描述: 根据product中id值是否为空，来进行更新或插入操作。需要管理员权限
         *
    ...
    public ServerResponse setSaleStatus(HttpSession session, Integer productId, Integer status) {
        /**
         * 功能描述: 需要管理员权限，设置productId对应商品的status
         *
    ...
    public ServerResponse getDetail(HttpSession session, Integer productId) {
        /**
         * 功能描述: 需要管理员权限，获取productId对应商品的详情
         *
    ...
    public ServerResponse getList(HttpSession session, @RequestParam(value = "pageNum", defaultValue = "1") int pageNum, @RequestParam(value = "pageSize", defaultValue = "10") int pageSize) {
        /**
         * 功能描述: 需要管理员权限，得到所有产品信息，结果为ProductListVo，并做分页处理。
         *
    ...
    public ServerResponse productSearch(HttpSession session, String productName, Integer productId, @RequestParam(value = "pageNum", defaultValue = "1") int pageNum, @RequestParam(value = "pageSize", defaultValue = "10") int pageSize) {
        /**
         * 功能描述: 需要管理员权限，使用productName做关键字或者productId查询product，结果为分页的ProductListVo
         *
    ...
    public Map richtextImgUpload(HttpSession session, @RequestParam(value = "upload_file", required = false) MultipartFile file, HttpServletRequest request, HttpServletResponse response) {
        /**
         * 功能描述: 需要管理员权限，文件上传，配合前端返回对应格式。基本同upload.do接口。
         *
